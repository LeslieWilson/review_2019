...
# Your code here
#
# def company_name(array,company_name)
#     company_information = {}
# array.each do |hash|
#     hash.each do |key, value|
#         if key == company_name
#             company_information = hash[key]
# end
# end
# end
# puts company_information
# end
#
# company_name(nasa_data, "VCU Brandcenter")
...
#         hash.each do |key, value|
#             puts "#{key} is in
#             #{value["location_1_city"]}
#             #{value['location_1_state']}"
#
#         end
#     end
# end
...
def id_number(array)
    array.each do |hash|
        hash.each do |key, value|
            puts "#{key} has
            #{value["computed_region_cbhk_fwbd"]} id number"
...
def position(array)
    array.each do |hash|
        hash.each do |key,value|
            puts "#{key} has the listed position: #{value["position"]}"
        end
    end
end
position(nasa_data)
...
def type(array)
    array.each do |hash|
        hash.each do |key,value|
            puts "#{key} has a location_1 type of #{value["location_1"]["type"]}"
        end
    end
end
...
def number(array)
    company = "Amoeba Culture"
    array.each do |hash|
        hash.each do |key, value|
            if value["computed_region_nnqa_25f4"]> hash[company]["computed_region_nnqa_25f4"]
                company = key
            end
        end
    end
...
#     array.each do |hash|
#         hash.each do |key,value|
#             if value["email_hosts"] == "gmail.com"
#                 sum += 1
#         end
#     end
#     puts "the number of companies that use gmail is #{sum}"
# end
# end
# gmail(nasa_data)
